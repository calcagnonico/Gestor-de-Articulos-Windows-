...
- Posibilidad de desactivar/activar articulos logicamente. Esto se hizo agregando la palabra -OFF al codigo del articulo ya que no se podia modificar la estructura de la base de datos.
- Ventana de configuracion para editar la ruta del servidor de la BD y la ruta de la imagen por defecto. Tambien se agrego la posibilidad de elegir la carpeta de backups de las imagenes en esta ventana.
- El programa tambien hace backups de las imagenes webs.
